...
class Actor:
    ...
    def get_text(self):
        """
        Gets the actor's textual presentation.

        Returns:
            string: The actor's textual presentation.
        """
        return self._text
    ...
    def move_next(self):
        """
        Moves the actor to is new position accordin to its velocity.
        Will wrap the position from one side of the screen to the other when it reaches the given maximum x and y values.
