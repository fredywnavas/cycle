...
class VideoService:
    ...
    def clear_buffer(self):
        ...
        This method should be called at the beginningn of the game's output phase.
        """
        pyray.begin_drawing()
    ...
    def flush_buffer(self):
        ...
        This method should be called at the end of teh game's output phase.
        """
        pyray.end_drawing()
    ...
    def open_window(self):
        """
        OPens a new windo with the provided title.
